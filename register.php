...
<body>
    ...
    <div class="container py-4">
        ...
        <form class="w-7/12 mx-auto p-5 shadow-lg  rounded-md mt-8" action="#">
            ...
            <div class="flex flex-col gap-1 my-3 relative">
                ...
                <input class="w-full bg-slate-50 border border-gray-300 outline-none px-10 py-2 rounded-md transition-all duration-150 focus:border-blue-500" type="password" placeholder="RePassword">
            ...
            <div class="flex flex-row justify-end py-1 pr-2">
                <a class="text-blue-500 hover:text-blue-500 transition-all duration-150 underline" href="./login.php">เข้าสู่ระบบ</a>
            </div>
            <button class="mt-3 w-full rounded-md bg-blue-500 text-white py-2 hover:bg-blue-600 transition-all duration-150">
                สมัครสมาชิก
            </button>
        </form>
    </div>
